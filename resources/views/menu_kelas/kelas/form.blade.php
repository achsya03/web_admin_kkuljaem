...
<div class="position-relative form-group">
    ...
    <input name="judul_kelas" id="judul_kelas" placeholder="" class="form-control" required>
</div>
<div class="position-relative form-group">
    <label for="exampleEmail" class="">Deskripsi Kelas</label>
    <textarea name="deskripsi" id="deskripsi" placeholder="" class="form-control" required></textarea>
</div>
<div class="position-relative form-group">
    <label for="exampleSelectMulti" class="">Nama Mentor</label>
    <select multiple name="mentor[]" id="mentor" class="form-control" required>
