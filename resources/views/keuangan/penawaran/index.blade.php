    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input name="status_aktif" id="status_aktif" value="1" hidden placeholder="Masukkan Keterangan singkat disini"  class="form-control">
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.message !== 'Success') {
                    ...
                    document.getElementById('status_aktif').value = response.data['status_aktif'];
                }
            }
        });
